...
export function ProjectCard({ opportunity }: { opportunity: Opportunity }) {
  return <article className="group grid border-2 border-foreground bg-white sm:grid-cols-[220px_1fr]">
    <div className="relative min-h-52 overflow-hidden border-b-2 border-foreground sm:border-b-0 sm:border-r-2"><Image src={opportunity.image} alt="" fill className="object-cover transition duration-500 group-hover:scale-105" /></div>
