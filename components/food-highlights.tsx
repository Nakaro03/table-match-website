  ...
  return (
    <section id="food" className="py-24 sm:py-32 bg-secondary/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative aspect-[4/3] sm:col-span-2 overflow-hidden rounded-2xl border border-border shadow-sm">
            <Image
          ...
          <div className="relative aspect-[4/3] sm:aspect-auto overflow-hidden rounded-2xl border border-border shadow-sm">
            <Image
