  ...
  return (
    <main className="min-h-screen bg-paper">
      ...
      <section className="mx-auto flex min-h-[78vh] max-w-4xl items-center px-5 py-28 sm:px-8">
        <div className="w-full border-2 border-foreground bg-background p-7 shadow-[14px_14px_0_#0757C8] sm:p-12">
          <CheckCircle2 className="h-16 w-16 text-primary" />
          <p className="mt-8 font-mono text-sm font-bold tracking-widest text-action-orange">APPLICATION RECEIVED</p>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link href="/projects" className="inline-flex items-center justify-center gap-2 bg-action-orange px-6 py-3 font-bold text-white">PROJECTを見る<ArrowRight className="h-4 w-4" /></Link>
