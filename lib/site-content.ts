...
export const topics: Story[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "この回で特別だったのは、K2Tプランニングが東京から長野まで来てくださったことです。「関東で働きたいなら、関東に出るしかない」——そう考えていた学生にとって、東京の経営者がわざわざ地元のテーブルまで足を運んでくれるという経験は、思っていた以上に新鮮なものでした。地域にいながら、関東の仕事や会社と直接つながれる。そんな選択肢があることを、身をもって感じられた回になりました。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "第4回を終えて、開催実績は累計4回、参加学生は延べ81名に。次の第5回は、再び長野での開催でした。",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "茅野市Kiitosで開催した第3回 Table Match 長野を、地元テレビ局LCVに取材いただきました。当日は、学生と経営者が同じテーブルで食事をしながら、仕事や地域の未来について話す様子を撮影していただきました。",
      "運営メンバーからは、学生自身が企画・企業への声かけ・当日の進行まで担っていることや、イベント後の会社見学・インターンまで伴走していることを紹介しました。",
      "代表の中村は、この取材についてこう振り返っています。「僕たち自身もまだ試行錯誤している途中ですが、こうして地域のメディアに取り上げていただけたことは、とても嬉しく感じています。」",
      "今後も地域の大学、企業、自治体と協力し、学生が挑戦を見つけられる接点を広げます。放送の様子は、下のリンクからご覧いただけます。",
    ],
  },
]
